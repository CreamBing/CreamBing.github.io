...
{% link #401 BinaryWatch(二进制手表) https://leetcode.com/problems/binary-watch/ %}
```java
/**
 * creambing.com Inc.
 * Copyright (c) 2016-2017 All Rights Reserved.
...
<font color="#eb4d4b">1.最开始的时候没有设计最后一个参数，for循环中i=0而不是index,这样导致选了之后在选，重复了，这里我们没有恢复状态，因为我们也没有改变状态，我们只是遍历取合适的值</font>
<font color="#eb4d4b">2.另外一个小问题是组合的时候需要清空列表</font>
